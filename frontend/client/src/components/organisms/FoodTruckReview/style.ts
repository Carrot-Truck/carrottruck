...
export const FoodTruckInfoContainer = styled.div`
...
export const FoodTruckInfoSection = styled.section`
  margin-bottom: 16px; // 섹션 간 여백

  &:last-child {
    margin-bottom: 0; // 마지막 섹션 하단 여백 제거
  }
`;
