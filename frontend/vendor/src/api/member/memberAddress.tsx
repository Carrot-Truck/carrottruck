...
export async function editMemberAddress(memberAddressId: number, data: Object, success: any, fail: any) {
    await api.patch(`/${memberAddressId}}`, data).then(success).catch(fail);
}

export async function editSelected(data: Object, success: any, fail: any) {
